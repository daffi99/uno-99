...
export default function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 md:p-8">
      <header className="mb-8 flex flex-col gap-4 rounded-3xl border border-white/60 bg-white/70 p-4 shadow-lg shadow-slate-200/50 backdrop-blur-md dark:border-white/10 dark:bg-slate-950/55 dark:shadow-slate-950/40 sm:flex-row sm:items-center sm:justify-between">
